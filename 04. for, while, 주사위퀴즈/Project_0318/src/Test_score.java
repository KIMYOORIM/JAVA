...
public class Test_score {
	public static void main(String[] args) {
		...
		yoorim = scoreNumber.nextInt(101);
		nahyun = scoreNumber.nextInt(101);
		hanbin = scoreNumber.nextInt(101);
		...
		/*
		 * if ((yoorim == hanbin){ System.out.println("hanbin과 yoorim이 공동 이등입니다."); } ||
		 * (yoorim == nahyun) || (hanbin == nahyun)){ System.out.println("동점입니다.");
		 */
